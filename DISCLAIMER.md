...
DrDebits is an independent, open-source technical operating guide designed to provide ethical boundaries and compliance routing for large language models (LLMs) assisting with Australian accounting, tax, and BAS workflows.

## 2. No Tax or Legal Advice
The content, guidance rules, and catalogues contained within DrDebits:
- **Do not constitute professional tax, accounting, audit, or legal advice.**
- **Do not establish a tax agent-client or fiduciary relationship.**
...
## 4. Name & Endorsement
"Dr" is part of the project name only and does not represent academic, medical, or statutory qualifications. DrDebits is not affiliated with or endorsed by the TPB, APESB, AUSTRAC, CA ANZ, CPA Australia, or the IPA.
